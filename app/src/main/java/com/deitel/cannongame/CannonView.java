...
public class CannonView extends SurfaceView
    ...
    public static double TARGET_PIECES = 9;
    ...
    public static  double BLOCKER_SPEED_PERCENT = 0.5;
    ...
    public void newGame(int level) {
        ...
        for (int n = 0; n < TARGET_PIECES; n++) {
            ...
            // for Target n
            double velocity = screenHeight * ((random.nextDouble()/12) *
        ...
        blocker = new Blocker(this, Color.BLACK, MISS_PENALTY,
                ...
                (float) ((0.5 - BLOCKER_LENGTH_PERCENT / 2) * screenHeight),
                (int) (BLOCKER_WIDTH_PERCENT * screenWidth),
                (float) (BLOCKER_LENGTH_PERCENT * screenHeight),
        ...
        gameResult = new DialogFragment() {
            ...
            public Dialog onCreateDialog(Bundle bundle) {
                ...
                if (messageId == R.string.win) {
                    ...
                    msg = "Start level " + (mLevel + 1);
                } else
                    msg = "Try again!";


                builder.setPositiveButton(msg,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                if (messageId == R.string.win) {
                                    BLOCKER_SPEED_PERCENT+=0.2;
                                    mLevel++;
                                    newGame(mLevel); // set up and start a new game
                                } else {
                                    newGame(mLevel);
                                }
                            }
...
/////////////////////////////////////////////////////////
        ...
        if (cannon.getCannonball() != null &&
            ...
            increaseBlockerLength(); //Increase blocker Length
    ...
    private void increaseBlockerLength() {

        float currentLength = blocker.getLength();

        float increase = currentLength * (2 / 10000.0f);

        float totalLength = currentLength + increase;

        blocker.setLength(totalLength);
