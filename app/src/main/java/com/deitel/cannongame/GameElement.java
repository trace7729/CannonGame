...
public class GameElement {
   ...
   protected RectF shape; // the GameElement's rectangular bounds
   ...
   public GameElement(CannonView view, int color, int soundId, int x,
      float y, int width, float length, float velocityY) {
      this.view = view;
      paint.setColor(color);
      shape = new RectF((float)(x), y, (float)(x + width), y + length); // set bounds
